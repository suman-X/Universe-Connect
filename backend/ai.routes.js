...
// AI Team Builder
router.post('/team-builder', authMiddleware, async (req, res) => {
  try {
    const { hackathon_id, radius_km = 50 } = req.body;
    ...
    // Use Gemini to analyze and rank teammates
...
Format: Return ONLY a valid JSON array, no markdown.`;
    ...
    if (jsonMatch) {
      ...
      // Fallback: return nearby users with simple scoring
